...
@XmlRootElement(name = "CustomerRequest", namespace = "http://www.javatechie.com/spring/soap/api/loanEligibility")
public class CustomerRequest {

    @XmlElement(namespace = "http://www.javatechie.com/spring/soap/api/loanEligibility", required = true)
