...
@XmlRootElement(name = "Acknowledgement", namespace = "http://www.javatechie.com/spring/soap/api/loanEligibility")
public class Acknowledgement {

    @XmlElement(namespace = "http://www.javatechie.com/spring/soap/api/loanEligibility")
    protected boolean isEligible;
    @XmlElement(namespace = "http://www.javatechie.com/spring/soap/api/loanEligibility")
    protected long approvedAmount;
    @XmlElement(name = "CriteriaMismatch", namespace = "http://www.javatechie.com/spring/soap/api/loanEligibility", required = true)
