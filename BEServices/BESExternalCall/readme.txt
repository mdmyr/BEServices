...
0. Prerequisite: configure application (trusted) user to be used for calls from external service to HUB.
   For details read "Informatica Multidomain MDM Security Guide".
   This sample code uses "e360" as an application user, but it should be replaced with proper one.
